...
def replace_in_file(filepath: str, info: dict):
    ...
    with open(filepath, "wt") as fout:
        fout.write(meta)
    print(f"File {filepath} has been updated with informations from PyPi.")  # noqa analysis:ignore
...
if __name__ == '__main__':
    ...
    print("Information of the last published PyPi package :", info)  # noqa analysis:ignore
