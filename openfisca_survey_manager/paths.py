...
try:
    ...
    default_config_files_directory = os.path.join(
        taxipp_location, ".config", "openfisca-survey-manager"
    )
except ImportError:
...
try:
    ...
    default_config_files_directory = BaseDirectory.save_config_path(
...
if default_config_files_directory is None:
    ...
    log.debug(
        f"Using default_config_files_directory = {default_config_files_directory}"
    )
