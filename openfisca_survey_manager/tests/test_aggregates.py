from openfisca_country_template.reforms.modify_social_security_taxation import (
...
def test_aggregates():
    ...
    for variable in variables:
        aggregate_before = survey_scenario.compute_aggregate(
            variable, period=period, use_baseline=True
        )
