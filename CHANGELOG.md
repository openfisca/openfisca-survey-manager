...
* Technical changes
  ...
  - Fix extraction of `categorical_strategy` parameter before calling reader for non-stata formats
...
* New features
  - Introduce the possibility to use calmar on variables changed with expressions.
...
* Technical changes
  - Fix `test_scenario` to use correct `SurveyScenario` class.
...
* Technical changes
  - Fix categorical dtype check when initialising a Simulation.
